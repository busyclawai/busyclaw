...
//
//   primaryKey  → a unique index over the key columns. NOT `_id`: euroclaw rows carry their own
...
import type { SchemaDeclaration, TableSchema } from "@euroclaw/contracts";
...
export type MongoIndexSpec = {
	...
	name: string;
	/** Field → direction (always ascending; euroclaw declares no directional intent). */
...
export function generateMongoIndexes(options: MongoGenerateOptions): string {
	...
	const lines: string[] = [
		"// Generated by `euroclaw db generate --target mongodb` — do not edit by hand.",
		"// Run against your database: mongosh <connection-string> euroclaw-indexes.mongo.js",
		"//",
