...
// getBusyclawTables throws at runtime if a plugin/host schema redefines a core column. The same rule,
 ...
 * core `claw` column — the compile-time mirror of {@link getBusyclawTables}' runtime guard. Resolves to
