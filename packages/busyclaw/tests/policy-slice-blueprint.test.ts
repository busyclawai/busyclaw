...
// governance chokepoint (core + policy-cedar). busyclaw stays ENGINE-AGNOSTIC: it exports the pieces;
// the HOST composes the cedar engineFor here (policy-cedar is a busyclaw devDep only). This
// composition IS busyclaw's public integration contract for customer policy.
...
import type { AuthzModel, PolicyEngine, ToolCall } from "@busyclaw/contracts";
import {
...
function setup() {
	...
	// "absent" = do NOT stamp runMode — the PRODUCTION reality (nothing stamps busyclaw__runMode yet),
